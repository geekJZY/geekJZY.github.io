        ...
        <div id="main-pub-card-container" class="">
            ...
            <div class="pub-card">
                <div class="row align-items-center section-item">
                    <div class="col-xs-12 col-md-3 col-lg-4 col-wrapper">
                        <div class="figure">
                                <img src="../paper_images/ECCV2022_DnA.png" width="18%">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-9 col-lg-8 col-wrapper">
                        <div class="title">
            ...
            <div class="pub-card">
                <div class="row align-items-center section-item">
                    <div class="col-xs-12 col-md-3 col-lg-4 col-wrapper">
                        <div class="figure">
                                <img src="../paper_images/Neruips2021_MAK.png" width="18%">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-9 col-lg-8 col-wrapper">
                        <div class="title">
            ...
            <div class="pub-card">
                <div class="row align-items-center section-item">
                    <div class="col-xs-12 col-md-3 col-lg-4 col-wrapper">
                        <div class="figure">
                                <img src="../paper_images/SDCLR.png" width="18%">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-9 col-lg-8 col-wrapper">
                        <div class="title">
            ...
            <div class="pub-card">
                <div class="row align-items-center section-item">
                    <div class="col-xs-12 col-md-3 col-lg-4 col-wrapper">
                        <div class="figure">
                                <img src="../paper_images/Neurips2020_ACL.png" width="18%">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-9 col-lg-8 col-wrapper">
                        <div class="title">
            ...
            <div class="pub-card">
                <div class="row align-items-center section-item">
                    <div class="col-xs-12 col-md-3 col-lg-4 col-wrapper">
                        <div class="figure">
                                <img src="../paper_images/CVPR2020_peek_a_boo.png" width="18%">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-9 col-lg-8 col-wrapper">
                        <div class="title">
            ...
            <div class="pub-card">
                <div class="row align-items-center section-item">
                    <div class="col-xs-12 col-md-3 col-lg-4 col-wrapper">
                        <div class="figure">
                                <img src="../paper_images/Neurips2019_E2train.png" width="18%">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-9 col-lg-8 col-wrapper">
                        <div class="title">
                            <a>
                                E<sup>2</sup>-Train: Training State-of-the-art CNNs with Over 80% Less Energy
                            </a>
                        </div>
                        <div class="authors">
            ...
            <div class="pub-card">
                <div class="row align-items-center section-item">
                    <div class="col-xs-12 col-md-3 col-lg-4 col-wrapper">
                        <div class="figure">
                                <img src="../paper_images/CVPR2019_GLNet.png" width="18%">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-9 col-lg-8 col-wrapper">
                        <div class="title">
...
:   **Research Intern**, *Microsoft*, Redmond, WA
      ...
      *Research on self-supervised pre-training*<br/>
      <li style="margin-top: -1rem">Explore self-supervised methods that can combine the benefits of both Mask Image Modeling (MIM) and Contrastive Learning (CL).</li>
